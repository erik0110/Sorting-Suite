...
import quick from '../scripts/quick.js';
...
describe('Quick Sort', () => {
  ...
  it('should sort a short array', function() {
    ...
    assert.deepEqual(quick(numberArray), [1, 3, 4, 7, 9]);
  })

  it('should sort a short array', function() {
    let numberArray = [-9, -4, -7, -3, -1];

    assert.deepEqual(quick(numberArray), [-9, -7, -4, -3, -1]);
  })
  ...
  it('should sort a large random array', function() {
    ...
    assert.deepEqual(quick(testArray), largeArray)
  })

  it('should sort alphabetically', function() {
    let letterArray = ["c", "f", "a", "m", "r", "e"];

    assert.deepEqual(quick(letterArray), ["a", "c", "e", "f", "m", "r"]);
  })
